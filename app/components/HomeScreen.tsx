    ...
    <div style={{ maxWidth: "480px", margin: "0 auto", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, padding: "16px" }}>
        <div style={{ display: "grid", gap: "12px" }}>
          ...
          {(() => {
            const now = new Date();
            const r16 = [...(KNOCKOUT_MATCHES.r16 || [])].sort((a, b) =>
            ...
            const TV: Record<string,string> = { "r16-89":"BBC","r16-90":"ITV","r16-91":"BBC","r16-92":"ITV","r16-93":"BBC","r16-94":"ITV","r16-95":"BBC","r16-96":"ITV" };
